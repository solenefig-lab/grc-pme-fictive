...
## **Livrables**
 ...
 | **pca-pra-santeconnect.md** | **Plan de Continuité et de Reprise d’Activité** : Procédures pour maintenir/restaurer les services critiques (API HL7/FHIR, Base D-002) en cas d’incident, avec **RTO/RPO** alignés sur les exigences du CHU (ex : activation sous 4h). | 🔄 En cours |
