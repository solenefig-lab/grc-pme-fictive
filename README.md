...
| [5](./semaine-5-ebios-rm/README.md) | EBIOS Risk Manager | [Atelier 1 - Cadrage et socle de sécurité](../grc-pme-fictive/semaine-5-ebios-rm/1-ebios-rm-santeconnect-cadrage.md) · [Atelier 2 - Sources de risque](../grc-pme-fictive/semaine-5-ebios-rm/2-sources-risque.md) · Scénario opérationnel - Compromission API CHU · Synthèse et plan d'action | 🔄 En cours |
