...
| **LIL — Art. 25** | Juridique | NIR — Numéro de Sécurité Sociale (donnée à protection renforcée) | Usage strictement limité aux obligations sociales et fiscales — autorisation CNIL requise pour tout autre usage | Amende pouvant atteindre 300 000€ (RGPD/LIL) + perte de confiance patients/salariés + responsabilité pénale possible selon les circonstances |
| **CSP — Art. R-1111-10 et R-1112-7** | Métier (Santé) | Données de santé — dossier médical et données de suivi médical | Obligation de conservation et d'archivage (20 ans pour le dossier médical hospitalier) | Amende jusqu'à 300 000€ + suspension possible par l'autorité compétente (CNIL ou ANS) + perte de confiance partenaires + responsabilité civile |
